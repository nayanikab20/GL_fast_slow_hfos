...
%Cortex cohfos
    ...
    TT.Properties.VariableNames=['Metric' cellfun(@(equis) strrep(equis,'_','-'),g,'UniformOutput',false)].';
        ...
        writematrix('coocur HFO',strcat('HPC_HFO_160_,','.xls'),'Sheet',1,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',1,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',1,'Range',excel_range(1).(rat_no))    
...
%Cortex singles
    ...
    TT.Properties.VariableNames=['Metric'  cellfun(@(equis) strrep(equis,'_','-'),g,'UniformOutput',false)].';
        ...
        writematrix('Single HFO',strcat('HPC_HFO_160_,','.xls'),'Sheet',2,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',2,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',2,'Range',excel_range(1).(rat_no))  
%%
%HPC Multiplets
...
writematrix('HPC multiplets',strcat('HPC_HFO_160_,','.xls'),'Sheet',3,'Range','B1')
writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',3,'Range',excel_range(4).(rat_no))
writetable(Tab,strcat('HPC_HFO_160_,', '.xls'),'Sheet',3,'Range',excel_range(3).(rat_no))  
...
%HPC ripples coocurrent with hfos (cohfos)
    ...
    TT.Properties.VariableNames=['Metric' cellfun(@(equis) strrep(equis,'_','-'),g,'UniformOutput',false)].';
        ...
        writematrix('Coocur Ripples with HFOs',strcat('HPC_HFO_160_,','.xls'),'Sheet',4,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',4,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',4,'Range',excel_range(1).(rat_no))  
...
%HPC singles
    ...
    TT.Properties.VariableNames=['Metric' cellfun(@(equis) strrep(equis,'_','-'),g,'UniformOutput',false)].';
        ...
        writematrix('HPC Singles',strcat('HPC_HFO_160_,','.xls'),'Sheet',6,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',6,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',6,'Range',excel_range(1).(rat_no))  
...
%HPC Total
    ...
    TT.Properties.VariableNames=['Metric' cellfun(@(equis) strrep(equis,'_','-'),g,'UniformOutput',false)].';
        ...
        writematrix('Total HPC',strcat('HPC_HFO_160_,','.xls'),'Sheet',5,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',5,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',5,'Range',excel_range(1).(rat_no))  
...
%coocurrent HFOs
    ...
    TT.Properties.VariableNames=['Events' 'Metric' g];
        ...
        writematrix('Slow and Fast Coocur HFOs',strcat('HPC_HFO_160_,','.xls'),'Sheet',7,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',7,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',7,'Range',excel_range(1).(rat_no)) 
...
%Single HFOs
    ...
    TT.Properties.VariableNames=['Events' 'Metric' g];
        ...
        writematrix('slow and Fast Singles HFO',strcat('HPC_HFO_160_,','.xls'),'Sheet',8,'Range','B1')
        writematrix(rat_no,strcat('HPC_HFO_160_,','.xls'),'Sheet',8,'Range',excel_range(2).(rat_no))
        writetable(TT,strcat('HPC_HFO_160_,','.xls'),'Sheet',8,'Range',excel_range(1).(rat_no))  
